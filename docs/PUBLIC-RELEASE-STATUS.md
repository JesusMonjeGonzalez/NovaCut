...
native harness and build are the required local gates. The media corpus must be
redacted or synthetic, and the corpus runner now fails when no synchronization
